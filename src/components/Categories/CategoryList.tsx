...
export default function CategoryList({ categories, searchFilter, onRename, onDelete, onCreate }: Props) {
    ...
    return (
    <div className={`relative w-full grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 md:h-fit h-[calc(100%-120px)] gap-4 rounded-2xl pb-4 overflow-y-scroll max-h-full`}>
            <motion.div
