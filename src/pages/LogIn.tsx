...
export default function LogIn() {
    ...
    return (
        <div className="relative flex min-h-screen flex-col justify-center bg-gray-100 py-12 pt-0 sm:px-6 lg:px-8">
            {error && (
            ...
            <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                <div className="bg-white px-4 py-8 shadow-2xl sm:rounded-lg sm:px-10">
                    ...
                    <div className="mt-2 flex gap-4">
                        <button
                            onClick={() => googleLogin()}
                            className="flex flex-1 cursor-pointer items-center justify-center gap-2 rounded-lg border border-gray-300 bg-white py-2 font-semibold text-black transition hover:bg-gray-200"
                        >
                            <img
                                src={googleLogo}
                                alt="Google Logo"
